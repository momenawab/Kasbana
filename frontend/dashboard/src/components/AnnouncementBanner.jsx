...
export default function AnnouncementBanner() {
  ...
  return (
    <div className="flex items-start justify-between gap-3 bg-brand/10 px-4 py-2 text-sm text-slate">
      ...
      <button
        ...
        aria-label="Dismiss"
        className="shrink-0 rounded-ctl p-1 text-tx-2 hover:bg-brand/20 hover:text-slate"
      >
        <X size={16} />
      </button>
    </div>
