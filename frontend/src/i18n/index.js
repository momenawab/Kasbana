...
export const PAGE_PATHS = {
  ...
  checkout: { en: '/checkout', ar: '/ar/checkout' },
}
...
export const translations = {
  en: {
    ...
    checkout: {
      ...
      totalFree: 'EGP 0.00',
      trialNote: 'Your 14-day free trial starts now — you will not be charged today.',
      includes: 'Includes',
      formHeading: 'Your details',
      formSub: 'This creates your Stampn account and starts your trial.',
      labels: {
        business: 'Business name',
        name: 'Your name',
        email: 'Email',
      ...
      securityNote:
        'Card payment goes live once our gateway is connected. During pre-launch no card is charged — your plan starts on a 14-day free trial.',
      errors: {
        business: 'Please enter your business name.',
        name: 'Please enter your name.',
        email: 'Please enter your email.',
      ...
      success: {
        ...
        body: 'Your account is set up and your 14-day free trial has started. No card was charged.',
        note: 'Sign in to your dashboard to design your first loyalty card.',
        cta: 'Continue to your dashboard',
      },
      missingPlan: 'Please choose a plan first.',
    ...
    seo: {
      ...
      checkout: {
        title: 'Checkout — Stampn',
        description:
          'Complete your sign-up and start your 14-day free trial of your chosen Stampn plan.',
      },
      privacy: {
  ...
  ar: {
    ...
    checkout: {
      ...
      perMonth: '/شهر',
      perYear: '/سنة',
      totalLabel: 'الإجمالي المطلوب الآن',
      totalFree: '٠٫٠٠ ج.م',
      trialNote: 'تجربتك المجانية ١٤ يوم بتبدأ دلوقتي — مش هيتخصم منك أي حاجة النهارده.',
      includes: 'بتشمل',
      formHeading: 'بياناتك',
      formSub: 'ده بينشئ حسابك على Stampn ويبدأ فترة تجربتك.',
      labels: {
        business: 'اسم النشاط',
        name: 'اسمك',
        email: 'الإيميل',
        phone: 'رقم الموبايل',
        password: 'اختر كلمة سر',
      },
      consent: 'أوافق على سياسة الخصوصية والشروط.',
      submit: 'إتمام الطلب',
      submitting: 'بنجهّز حسابك…',
      securityNote:
        'الدفع بالكارت هيشتغل بمجرد ما نربط بوابة الدفع. خلال فترة ما قبل الإطلاق مفيش خصم — باقتك بتبدأ بتجربة مجانية ١٤ يوم.',
      errors: {
        business: 'من فضلك اكتب اسم النشاط.',
        name: 'من فضلك اكتب اسمك.',
        email: 'من فضلك اكتب إيميلك.',
        emailInvalid: 'من فضلك اكتب إيميل صحيح.',
        phone: 'من فضلك اكتب رقم موبايلك.',
        password: 'من فضلك اختر كلمة سر.',
        passwordShort: 'استخدم ٨ حروف على الأقل.',
        consent: 'لازم توافق على سياسة الخصوصية عشان تكمل.',
        exists: 'في حساب موجود بالفعل بالإيميل ده. جرّب تسجّل الدخول.',
        fix: 'من فضلك صحّح الحقول المعلّمة وحاول تاني.',
        network: 'مقدرناش نوصل للسيرفر. اتأكد من اتصالك وحاول تاني.',
        generic: 'حصل خطأ. حاول تاني من فضلك.',
      },
      success: {
        badge: 'تم الطلب',
        title: 'حسابك جاهز! 🎉',
        body: 'حسابك اتجهّز وتجربتك المجانية ١٤ يوم بدأت. مفيش أي خصم اتعمل.',
        note: 'سجّل دخولك على لوحة التحكم عشان تصمّم أول كارت ولاء.',
        cta: 'كمّل للوحة التحكم',
      },
      missingPlan: 'اختر باقة الأول من فضلك.',
      choosePlan: 'شوف الباقات',
    },
    privacy: {
    ...
    seo: {
      ...
      checkout: {
        title: 'إتمام الطلب — Stampn',
        description: 'أكمل تسجيلك وابدأ تجربتك المجانية ١٤ يوم على الباقة اللي اخترتها.',
      },
      privacy: {
