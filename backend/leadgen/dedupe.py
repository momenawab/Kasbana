...
_FILLER_TOKENS: frozenset[str] = frozenset(
    {
        "the", "and", "for", "of", "co", "company", "group", "est",
        "llc", "ltd", "inc",
        "شركه", "مجموعه",
    }
)
...
_BRANCH_TOKENS: frozenset[str] = frozenset(
    {
        "branch", "فرع",
        # Greater Cairo
        "maadi", "zamalek", "heliopolis", "mohandessin", "mohandiseen", "dokki",
        "nasr", "tagamoa", "tagamou", "rehab", "madinaty", "korba", "downtown",
        "obour", "shorouk", "zayed", "october", "6th", "sheraton", "manial",
        # Alexandria
        "smouha", "gleem", "stanley", "sidi", "bishr", "roushdy",
        # Arabic forms, post-fold (ta marbuta → ha, alef forms already folded)
        "المعادي", "معادي", "الزمالك", "زمالك", "مصر", "الجديده", "المهندسين",
        "مهندسين", "الدقي", "دقي", "نصر", "التجمع", "تجمع", "الرحاب",
        "زايد", "اكتوبر", "سموحه", "ستانلي",
    }
)
...
_PLATFORM_DOMAINS: frozenset[str] = frozenset(
    {
        ...
        "twitter.com", "x.com", "linkedin.com", "youtube.com", "wa.me",
        "whatsapp.com", "t.me", "telegram.me", "snapchat.com", "threads.net",
        # Link aggregators
        "linktr.ee", "linkin.bio", "beacons.ai", "carrd.co", "milkshake.app",
        # Delivery / listing marketplaces
        "talabat.com", "elmenus.com", "otlob.com", "hungerstation.com",
        "ubereats.com", "deliveroo.com", "glovoapp.com", "instashop.com",
        "zomato.com", "tripadvisor.com", "yelp.com", "foursquare.com",
        # Booking / hospitality parents
        "booking.com", "airbnb.com", "opentable.com", "thefork.com",
        "ihg.com", "marriott.com", "hilton.com", "accor.com", "hyatt.com",
        # Generic site builders' shared domains (a business on its own custom
        # domain is unaffected; only the shared host is excluded).
        "wixsite.com", "business.site", "godaddysites.com", "weebly.com",
        "blogspot.com", "wordpress.com", "square.site", "shopify.com",
